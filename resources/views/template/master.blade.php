...
<head>
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('ui/assets/css/argon-dashboard.css?v=2.1.0') }}" rel="stylesheet" />
</head>
...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <script src="{{ asset('ui/assets/js/argon-dashboard.min.js?v=2.1.0') }}"></script>
</body>
